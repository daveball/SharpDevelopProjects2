//
// CitizenPhotoUploadRequestType.cs
//
...
{
	public class CitizenPhotoUploadRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public CitizenPhotoUploadRequestType() : base() { SetCollectionParents(); }

		public CitizenPhotoUploadRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CitizenPhotoUploadRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CitizenPhotoUploadRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CitizenPhotoUploadRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "CitizenPhotoUploadRequest");
		}
        ...
        {
            CitizenPhotoUploadRequestType parent;
            public CitizenPhotoUploadRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenPhotoUploadRequestType parent;
			public UCRNEnumerator(CitizenPhotoUploadRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenPhotoUploadRequestType parent;
			public CASCitizenGUIDEnumerator(CitizenPhotoUploadRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CitizenPhotoEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenPhotoUploadRequestType parent;
			public CitizenPhotoEnumerator(CitizenPhotoUploadRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
