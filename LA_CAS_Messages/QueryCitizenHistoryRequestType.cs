//
// QueryCitizenHistoryRequestType.cs
//
...
{
	public class QueryCitizenHistoryRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public QueryCitizenHistoryRequestType() : base() { SetCollectionParents(); }

		public QueryCitizenHistoryRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public QueryCitizenHistoryRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public QueryCitizenHistoryRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public QueryCitizenHistoryRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "QueryCitizenHistoryRequest");
		}
        ...
        {
            QueryCitizenHistoryRequestType parent;
            public QueryCitizenHistoryRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			QueryCitizenHistoryRequestType parent;
			public UCRNEnumerator(QueryCitizenHistoryRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			QueryCitizenHistoryRequestType parent;
			public CASCitizenGUIDEnumerator(QueryCitizenHistoryRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
