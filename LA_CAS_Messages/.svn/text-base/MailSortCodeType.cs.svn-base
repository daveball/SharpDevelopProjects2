...
namespace LA_CAS_Messages.AddressAndPersonalDetails2
{
	...
	public class MailSortCodeType : SchemaString
	{
		...
		public MailSortCodeType() : base()
		{
		}

		public MailSortCodeType(string newValue) : base(newValue)
		{
			Validate();
		}

		public MailSortCodeType(SchemaString newValue) : base(newValue)
		{
			Validate();
		}
