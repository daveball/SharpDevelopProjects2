...
{
	public class CitizenExtendedDetailsType : Altova.Xml.Node
	{
		#region Forward constructors

		public CitizenExtendedDetailsType() : base() { SetCollectionParents(); }

		public CitizenExtendedDetailsType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CitizenExtendedDetailsType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CitizenExtendedDetailsType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CitizenExtendedDetailsType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "core:CitizenExtendedDetailsType");
		}
        ...
        {
            CitizenExtendedDetailsType parent;
            public CitizenExtendedDetailsType Parent
			{
				set
				{
					parent = value;
        ...
        public class CitizenNameEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public CitizenNameEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class DateOfBirthEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public DateOfBirthEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class DateOfDeathEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public DateOfDeathEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class GenderEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public GenderEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class MothersBirthNameEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public MothersBirthNameEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class PlaceOfBirthEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExtendedDetailsType parent;
			public PlaceOfBirthEnumerator(CitizenExtendedDetailsType par) 
			{
				parent = par;
				nIndex = -1;
			}
