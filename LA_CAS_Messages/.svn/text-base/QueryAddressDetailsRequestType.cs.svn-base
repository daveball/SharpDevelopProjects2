//
// QueryAddressDetailsRequestType.cs
//
...
{
	public class QueryAddressDetailsRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public QueryAddressDetailsRequestType() : base() { SetCollectionParents(); }

		public QueryAddressDetailsRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public QueryAddressDetailsRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public QueryAddressDetailsRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public QueryAddressDetailsRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "QueryAddressDetailsRequest");
		}
        ...
        {
            QueryAddressDetailsRequestType parent;
            public QueryAddressDetailsRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			QueryAddressDetailsRequestType parent;
			public UCRNEnumerator(QueryAddressDetailsRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			QueryAddressDetailsRequestType parent;
			public CASCitizenGUIDEnumerator(QueryAddressDetailsRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
