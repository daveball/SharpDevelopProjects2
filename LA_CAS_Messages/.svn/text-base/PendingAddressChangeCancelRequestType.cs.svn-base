//
// PendingAddressChangeCancelRequestType.cs
//
...
{
	public class PendingAddressChangeCancelRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public PendingAddressChangeCancelRequestType() : base() { SetCollectionParents(); }

		public PendingAddressChangeCancelRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public PendingAddressChangeCancelRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public PendingAddressChangeCancelRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public PendingAddressChangeCancelRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "PendingAddressChangeCancelRequest");
		}
        ...
        {
            PendingAddressChangeCancelRequestType parent;
            public PendingAddressChangeCancelRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			PendingAddressChangeCancelRequestType parent;
			public UCRNEnumerator(PendingAddressChangeCancelRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			PendingAddressChangeCancelRequestType parent;
			public CASCitizenGUIDEnumerator(PendingAddressChangeCancelRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
