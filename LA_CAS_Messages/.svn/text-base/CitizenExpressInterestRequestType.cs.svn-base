//
// CitizenExpressInterestRequestType.cs
//
...
{
	public class CitizenExpressInterestRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public CitizenExpressInterestRequestType() : base() { SetCollectionParents(); }

		public CitizenExpressInterestRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CitizenExpressInterestRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CitizenExpressInterestRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CitizenExpressInterestRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "CitizenExpressInterestRequest");
		}
        ...
        {
            CitizenExpressInterestRequestType parent;
            public CitizenExpressInterestRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExpressInterestRequestType parent;
			public UCRNEnumerator(CitizenExpressInterestRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenExpressInterestRequestType parent;
			public CASCitizenGUIDEnumerator(CitizenExpressInterestRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
