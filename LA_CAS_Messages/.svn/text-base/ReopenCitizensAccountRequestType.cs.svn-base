//
// ReopenCitizensAccountRequestType.cs
//
...
{
	public class ReopenCitizensAccountRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public ReopenCitizensAccountRequestType() : base() { SetCollectionParents(); }

		public ReopenCitizensAccountRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ReopenCitizensAccountRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ReopenCitizensAccountRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ReopenCitizensAccountRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ReopenCitizensAccountRequest");
		}
        ...
        {
            ReopenCitizensAccountRequestType parent;
            public ReopenCitizensAccountRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			ReopenCitizensAccountRequestType parent;
			public UCRNEnumerator(ReopenCitizensAccountRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			ReopenCitizensAccountRequestType parent;
			public CASCitizenGUIDEnumerator(ReopenCitizensAccountRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
