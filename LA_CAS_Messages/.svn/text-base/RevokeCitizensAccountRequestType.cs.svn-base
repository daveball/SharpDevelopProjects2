//
// RevokeCitizensAccountRequestType.cs
//
...
{
	public class RevokeCitizensAccountRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public RevokeCitizensAccountRequestType() : base() { SetCollectionParents(); }

		public RevokeCitizensAccountRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public RevokeCitizensAccountRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public RevokeCitizensAccountRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public RevokeCitizensAccountRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "RevokeCitizensAccountRequest");
		}
        ...
        {
            RevokeCitizensAccountRequestType parent;
            public RevokeCitizensAccountRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			RevokeCitizensAccountRequestType parent;
			public UCRNEnumerator(RevokeCitizensAccountRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			RevokeCitizensAccountRequestType parent;
			public CASCitizenGUIDEnumerator(RevokeCitizensAccountRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
