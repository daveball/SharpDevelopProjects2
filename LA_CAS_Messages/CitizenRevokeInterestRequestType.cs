//
// CitizenRevokeInterestRequestType.cs
//
...
{
	public class CitizenRevokeInterestRequestType : Altova.Xml.Node
	{
		#region Forward constructors

		public CitizenRevokeInterestRequestType() : base() { SetCollectionParents(); }

		public CitizenRevokeInterestRequestType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CitizenRevokeInterestRequestType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CitizenRevokeInterestRequestType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CitizenRevokeInterestRequestType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "CitizenRevokeInterestRequest");
		}
        ...
        {
            CitizenRevokeInterestRequestType parent;
            public CitizenRevokeInterestRequestType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenRevokeInterestRequestType parent;
			public UCRNEnumerator(CitizenRevokeInterestRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenRevokeInterestRequestType parent;
			public CASCitizenGUIDEnumerator(CitizenRevokeInterestRequestType par) 
			{
				parent = par;
				nIndex = -1;
			}
