...
namespace SeoAcknowledgeNotificationReceipt_v0_1.bs76662
{
	...
	public class VersionNumberType : SchemaLong
	{

		public VersionNumberType() : base()
		{
		}

		public VersionNumberType(string newValue) : base(newValue)
		{
			Validate();
		}

		public VersionNumberType(SchemaLong newValue) : base(newValue)
		{
			Validate();
		}
		...
		public  void Validate()
		{
			...
			if (CompareTo(GetMaxInclusive()) > 0)
				throw new System.Exception("Value of VersionNumberType is out of range.");
