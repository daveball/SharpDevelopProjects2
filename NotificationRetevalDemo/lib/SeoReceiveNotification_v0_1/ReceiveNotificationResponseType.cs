//
// ReceiveNotificationResponseType.cs
//
...
{
	public class ReceiveNotificationResponseType : Altova.Xml.Node
	{
		#region Forward constructors

		public ReceiveNotificationResponseType() : base() { SetCollectionParents(); }

		public ReceiveNotificationResponseType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public ReceiveNotificationResponseType(XmlNode node) : base(node) { SetCollectionParents(); }
		public ReceiveNotificationResponseType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public ReceiveNotificationResponseType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "ReceiveNotificationResponse");
		}
        ...
        {
            ReceiveNotificationResponseType parent;
            public ReceiveNotificationResponseType Parent
			{
				set
				{
					parent = value;
        ...
        public class NotificationIDEnumerator: IEnumerator 
        {
			int nIndex;
			ReceiveNotificationResponseType parent;
			public NotificationIDEnumerator(ReceiveNotificationResponseType par) 
			{
				parent = par;
				nIndex = -1;
			}
