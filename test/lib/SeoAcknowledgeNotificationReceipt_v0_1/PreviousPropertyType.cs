...
{
	public class PreviousPropertyType : Altova.Xml.Node
	{
		#region Forward constructors

		public PreviousPropertyType() : base() { SetCollectionParents(); }

		public PreviousPropertyType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public PreviousPropertyType(XmlNode node) : base(node) { SetCollectionParents(); }
		public PreviousPropertyType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public PreviousPropertyType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "PreviousProperty");
		}
        ...
        {
            PreviousPropertyType parent;
            public PreviousPropertyType Parent
			{
				set
				{
					parent = value;
        ...
        public class UPRNEnumerator: IEnumerator 
        {
			int nIndex;
			PreviousPropertyType parent;
			public UPRNEnumerator(PreviousPropertyType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASAddressGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			PreviousPropertyType parent;
			public CASAddressGUIDEnumerator(PreviousPropertyType par) 
			{
				parent = par;
				nIndex = -1;
			}
