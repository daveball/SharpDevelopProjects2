//
// CitizenAccountDetailsGUIDType.cs
//
...
{
	public class CitizenAccountDetailsGUIDType : Altova.Xml.Node
	{
		#region Forward constructors

		public CitizenAccountDetailsGUIDType() : base() { SetCollectionParents(); }

		public CitizenAccountDetailsGUIDType(XmlDocument doc) : base(doc) { SetCollectionParents(); }
		public CitizenAccountDetailsGUIDType(XmlNode node) : base(node) { SetCollectionParents(); }
		public CitizenAccountDetailsGUIDType(Altova.Xml.Node node) : base(node) { SetCollectionParents(); }
		public CitizenAccountDetailsGUIDType(Altova.Xml.Document doc, string namespaceURI, string prefix, string name) : base(doc, namespaceURI, prefix, name) { SetCollectionParents(); }
		...
		public void SetXsiType()
		{
			...
			el.SetAttribute("type", "http://www.w3.org/2001/XMLSchema-instance", "core:CitizenAccountDetailsGUIDType");
		}
        ...
        {
            CitizenAccountDetailsGUIDType parent;
            public CitizenAccountDetailsGUIDType Parent
			{
				set
				{
					parent = value;
        ...
        public class UCRNEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public UCRNEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class CASCitizenGUIDEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public CASCitizenGUIDEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
		...
		public EntitlementCardNumberType NewNECNumber()
		{
			return new EntitlementCardNumberType();
		}

		public EntitlementCardNumberType GetNECNumberAt(int index)
		{
			return new EntitlementCardNumberType(GetDomNodeValue(GetDomChildAt(NodeType.Element, "", "NECNumber", index)));
		}
		...
		public EntitlementCardNumberType GetNECNumberValueAtCursor( XmlNode curNode )
		{
			if( curNode == null )
				  throw new Altova.Xml.XmlException("Out of range");
			else
				return new EntitlementCardNumberType( curNode.InnerText );
		}


		public EntitlementCardNumberType GetNECNumber()
		{
			return GetNECNumberAt(0);
		}

		public EntitlementCardNumberType NECNumber
		{
			get
			{
				return GetNECNumberAt(0);
		...
		public XmlNode AddNECNumber(EntitlementCardNumberType newValue)
		{
			if( newValue.IsNull() == false )
		...
		public void InsertNECNumberAt(EntitlementCardNumberType newValue, int index)
		{
			if( newValue.IsNull() == false )
				InsertDomChildAt(NodeType.Element, "", "NECNumber", index, newValue.ToString());
		}

		public void ReplaceNECNumberAt(EntitlementCardNumberType newValue, int index)
		{
        ...
        public class NECNumberEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public NECNumberEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
			...
			public EntitlementCardNumberType  Current 
			{
				get 
				{
        ...
        public class CitizenNameEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public CitizenNameEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class DateOfBirthEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public DateOfBirthEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class DateOfDeathEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public DateOfDeathEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class GenderEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public GenderEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class MothersBirthNameEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public MothersBirthNameEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
        ...
        public class PlaceOfBirthEnumerator: IEnumerator 
        {
			int nIndex;
			CitizenAccountDetailsGUIDType parent;
			public PlaceOfBirthEnumerator(CitizenAccountDetailsGUIDType par) 
			{
				parent = par;
				nIndex = -1;
			}
