...
namespace Altova.Types
{
	...
	public class DateTime : System.IComparable
	{
		...
		public int GetWeekOfMonth()
		{
			...
			DateTime startDate = new DateTime( myValue.Year, myValue.Month, 1);
			int nWeekday = (int)startDate.Value.DayOfWeek;
			nWeekday = nWeekday == 0 ? 7 : nWeekday - 1;
			int[] arWeek = new int[6];
			arWeek[0] = 0;
			arWeek[1] = 7 - nWeekday;
			...
			int week = 5;
			while( myValue.Day <= arWeek[week] ) week--;
			return week + 1;
		}
		...
		public static DateTime Now
		{
			get
			{
				...
				System.TimeSpan tzofs = System.TimeZone.CurrentTimeZone.GetUtcOffset( dt );
	...
	public class Duration
	{
		...
		public Duration(int newyears, int newmonths, int days, int hours, int minutes, int seconds, double partseconds, bool bnegative)
		{
			years = newyears;
			months = newmonths;
			myValue = new System.TimeSpan( days, hours, minutes, seconds, (int)(partseconds * 1000.0) );
			if( bnegative )
			{
				myValue = -myValue;
				years = -years;
		...
		public static Duration Parse( string s )
		{
			...
			while ( pos != newvalue.Length )
			{
				...
				switch ( foundState )
				{
				case 0: d.years = val; break;
				case 1: d.months = val; break;
				case 2: day = val; break;
				case 4: hour = val; break;
				case 5: minute = val; break;
				case 6: second = val; break;
				case 7: partsecond = val * System.Math.Pow(0.1, digits); break;
				}
			...
			d.myValue = new System.TimeSpan(day, hour, minute, second, (int)(partsecond * 1000));
			if (bNegative) 
			{
				d.myValue = -d.myValue;
				d.years = -d.years;
		...
		public override string ToString()
		{
			...
			double partsecond = (System.Math.Abs(myValue.Ticks) / 10000000.0) % 1.0;
